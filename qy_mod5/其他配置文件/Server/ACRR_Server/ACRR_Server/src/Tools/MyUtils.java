...
public class MyUtils {
	 ...
	 * @return 两点之间的距离
	 */
	public static double GetDistance(String lat1, String lng1, double lat2, double lng2) {
		return GetDistance(Double.parseDouble(lat1), Double.parseDouble(lng1), lat2, lng2);
	}
